...
* the 16-byte ``BBP1`` header and supported v1/v2/v3/v4/v5/v6 format version;
...
Examples:
  ...
  python3 tools/bbp_behavior_audit.py --pairs-dir /data/pairs_v6
  python3 tools/bbp_behavior_audit.py \
      --pairs-dir /data/pairs_v6 --replay-ids /data/bb2025.ids
"""
