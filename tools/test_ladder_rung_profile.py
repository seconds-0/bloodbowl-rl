...
class LadderRungProfileTests(unittest.TestCase):
    ...
    def test_arm_knob_defaults_to_s_both_and_maps_sparse_to_s4(self):
        ...
        self.assertIn("s_both|sparse|r0|r0_dist_half|r0_dist_quarter|r0_dist_zero|r0_dist_ball_half) ;;", source)
        self.assertRegex(
            source,
    ...
    def test_rung_rejects_unknown_arm(self):
        result = run(SCREEN, {**BASE, "LADDER_ENDZONE_MAXDIST": "6",
                              ...
                              "LADDER_ARM": "r9"})
        self.assertNotEqual(result.returncode, 0)
        self.assertIn("LADDER_ARM must be s_both, sparse, r0, r0_dist_half, r0_dist_quarter, r0_dist_zero or r0_dist_ball_half", result.stderr)
