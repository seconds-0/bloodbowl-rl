...
| chain 20 | **chain 9 output** (`1787584031608`, the same parent as chain 14) | **r0_poss_half** (frontier reward) | 2.8e-4, bot share 0.12, contact bot, **SEED 44, no knob: seed-only control** | RUNNING since Aug 27 17:32 PDT (`runs/ladder-d0-r0chain20-plain-20260827`, unit `r0chain20-1787876974`), 3B, ETA about 6.7 h. Varies the training seed and nothing else against chain 14, closing the parent/seed confound in the chain 14 vs chain 19 gap (D284). Not a promotion candidate |
