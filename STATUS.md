...
| chain 18 | chain 16 output (seed-43 twin of chain 9) | r0_blockev_half | 2.8e-4, bot share 0.12, contact bot, **seed 43** | RELAUNCHED Aug 27 03:01 PDT (first attempt died against the still-running exam), 3B, ETA Aug 27 ~15:00 PDT; the seed-matched replicate that makes r0_blockev_half the first two-training-seed arm of the campaign (D279) |
