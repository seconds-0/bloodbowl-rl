...
| chain 13 | chain 9 output (`1787584031608`) | **r0_poss_half** (frontier reward) | 2.8e-4, bot share 0.12, **offense bot (type 1) in the bank seat** | **RUNNING** since Aug 25 14:08 PDT as `runs/ladder-d0-r0chain13b-20260825`, unit `r0chain13-1787692078`, 3B (D271); a first attempt at 14:03 was refused by the one-trainer guard while the s43 exam ran |
