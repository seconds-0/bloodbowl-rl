...
| chain 7 | chain 2 output (`1787338735330`) | **r0_dist_half** (dist_ball 0.01, dist_endzone 0.02) | 2.8e-4, bot share 0.12, contact bot | RUNNING since Aug 23 16:45 PDT (`runs/ladder-d0-r0chain7-20260823`, unit `r0chain7-1787528708`), 3B, ETA ~23:45 PDT; first reward-anneal step (D263); acceptance = seeds 42+43 vs the chain 2 two-seed mean, non-inferiority keeps it |
