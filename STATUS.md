...
| chain 21 | **chain 16 output** (seed replicate of chain 9, the same parent as chain 19) | **r0_poss_half** (frontier reward) | 2.8e-4, bot share 0.12, contact bot, **SEED 45, no knob: parent control** | RUNNING since Aug 28 00:24 PDT (`runs/ladder-d0-r0chain21-plain-20260828`, unit `r0chain21-1787901828`), 3B, ETA about 6.7 h. The seed-matched replicate chain 19 never had: near chain 19 = continuation is parent-dependent, near chains 14/20 = chain 19 was one high exam draw and the plateau is confirmed on four seeds (D286). Not a promotion candidate |
