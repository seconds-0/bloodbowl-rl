...
| chain 17 | chain 9 output (`1787584031608`) | **r0_blockev_half** (block-EV family halved) | 2.8e-4, bot share 0.12, contact bot, seed 42 | DONE Aug 27 02:40 PDT, 3B clean (error_episodes 0, illegal_frac 0). Exam seeds 42/43: contact champion flat and direction-inconsistent (-0.020/+0.015 AWAY, +0.008/-0.018 HOME vs the pooled baseline), conceded not scored (one seed, D277), offense AWAY 0.613 on seed 42 with the seed-43 cell pending (D279) |
| chain 18 | chain 16 output (seed-43 twin of chain 9) | r0_blockev_half | 2.8e-4, bot share 0.12, contact bot, **seed 43** | RUNNING since Aug 27 02:57 PDT, 3B, ETA Aug 27 15:00 PDT; the seed-matched replicate that makes r0_blockev_half the first two-training-seed arm of the campaign (D279) |
...
| chain 17 seed 43 (offense cell pending) [native] | D279 | 0.552 / 0.484 | 0.474 / 0.444 | offense-bot AWAY pending |
| chain 17 two-seed mean, contact cells only (contact champion flat: -0.003 / -0.005 vs the chain 9 + chain 16 pooled mean, neither cell moving the same way on both exam seeds; conceded not scored at one training seed) [native] | D279 | 0.535 / 0.458 | 0.487 / 0.439 | offense-bot AWAY pending |
