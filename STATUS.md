...
| chain 14 | chain 9 output (`1787584031608`) | **r0_poss_half** (frontier reward) | 2.8e-4, bot share 0.12, contact bot, **no knob under test (plateau control)** | **RUNNING** since Aug 25 21:01 PDT as `runs/ladder-d0-r0chain14-20260825`, unit `r0chain14-1787716866`, 3B (D272); asks whether a plain 3B continuation at frontier settings moves the exam at all after five rejected knobs |
