...
| chain 17 | chain 9 output (`1787584031608`) | **r0_blockev_half** (NEW: block-EV family halved) | 2.8e-4, bot share 0.12, contact bot, seed 42 | RUNNING since Aug 26 19:56 PDT, 3B, ETA Aug 27 08:00 PDT; judged on CHAMPION cells only vs the chain 9 + chain 16 pooled mean (0.537/0.416, 0.492/0.406, 0.571/0.350) at a 0.02 floor; conceded not readable from one seed (D277), so chain 18 = same arm seed 43 from the chain 16 marker follows (D278) |
