...
| chain 22 | **chain 9 output** (the frontier, `1787584031608`) | **r0_poss_half_rush_zero** (NEW: `reward_rush_cost` 0.015 -> 0) | 2.8e-4, bot share 0.12, contact bot, **SEED 42, knob: the last un-annealed shaping term** | RUNNING since Aug 28 07:24 PDT (`runs/ladder-d0-r0chain22-rushzero-20260828`, unit `r0chain22-1787926840`), 3B, ETA about 6.7 h. Paired comparator is chain 14 (same parent, same seed, plain): 0.504/0.415, 0.444/0.410, 0.576/0.345. Champion cells at a 0.02 floor from this one seed; conceded and net not scored from one run (D288) |
