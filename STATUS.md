...
| chain 11 | chain 9 output (`1787584031608`) | **r0_poss_half_gain_half** (possession 0.015, ball gain 0.025, distance terms at r0_full) | 2.8e-4, bot share 0.12, contact bot | **RUNNING** since Aug 24 23:34 PDT, unit `r0chain11-1787639245`, 3B (~6.5 h, marker ~06:30 PDT Aug 25); the single-knob ball-gain half step from the chain 9 frontier (D268) |
