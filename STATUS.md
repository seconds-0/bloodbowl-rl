...
| chain 9 | chain 2 output (`1787338735330`) | **r0_poss_half** (possession 0.015, ball gain 0.05, distance terms at r0_full) | 2.8e-4, bot share 0.12, contact bot | RUNNING since Aug 24 08:07 PDT (`runs/ladder-d0-r0chain9-20260824`, unit `r0chain9-1787584026`), 3B, ETA ~14:50 PDT; possession annuity annealed alone, the D178 decomposition (D265); acceptance = seeds 42+43 vs the chain 2 two-seed mean, non-inferiority keeps it |
