...
| chain 12 | chain 9 output (`1787584031608`) | **r0_poss_half** (frontier reward) | **5.6e-4 (scale 2.0, entropy scaled too)**, bot share 0.12, contact bot | **RUNNING** since Aug 25 07:05 PDT, `runs/ladder-d0-r0chain12-20260825`, unit `r0chain12-1787666712`, 3B (D270); LR x2 retry on the annealed frontier (chain 3 lost it under r0_full from chain 2) |
