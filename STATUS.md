...
| chain 8 | chain 2 output (`1787338735330`) | **r0_dist_ball_half** (dist_ball 0.01, dist_endzone 0.04) | 2.8e-4, bot share 0.12, contact bot | RUNNING since Aug 24 00:35 PDT (`runs/ladder-d0-r0chain8-20260824`, unit `r0chain8-1787556902`), 3B, ETA ~07:15 PDT; ball-distance term annealed alone (D264); acceptance = seeds 42+43 vs the chain 2 two-seed mean, non-inferiority keeps it |
