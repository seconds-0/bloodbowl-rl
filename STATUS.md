...
| chain 15h | **chain 14 output** (`1787716871429`) | **r0_poss_half** (frontier reward) | 2.8e-4, bot share 0.12, contact bot, **no knob: horizon probe** (cumulative 6B of continuation from chain 9) | RUNNING since Aug 26 04:34 PDT, unit `r0chain15h-1787744096`, `runs/ladder-d0-r0chain15h-20260826`, 3B, ETA ~11:15 PDT. Branch, not a promotion: chain 9 stays the frontier. Verdict on seeds 42/43 vs the chain 9 mean under the D268 rule |
