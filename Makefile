...
BBP_V5_WRITER_TESTBIN := $(BUILD)/bbp_v5_writer_tests
PUFFER_TESTBINS := $(PUFFER_REWARD_TESTBIN) $(PUFFER_CONTACT_TESTBIN) $(PUFFER_STATE_BANK_TESTBIN) $(PUFFER_OBSERVATION_TESTBIN) $(BBP_V5_WRITER_TESTBIN)
...
$(BBP_V5_WRITER_TESTBIN): tools/test_bbp_v5_writer.c tools/bb_lockstep.c puffer/bloodbowl/bloodbowl.h $(SRC) $(ENGINE_HDR)
