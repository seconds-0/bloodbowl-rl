---
name: bb-rules
description: Look up and apply BB2025 rules for engine implementation, reward semantics, strategy interpretation, and replay edition hygiene. Use for rule locations, skill/trait interactions, BB2016/BB2020 deltas, current errata/FAQ, optional-choice policy surfaces, Stalling/Secure the Ball, or deciding whether a proposed reward represents the actual game objective.
---
